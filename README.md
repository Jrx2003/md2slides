...
├─┢� cgi-bin
┄1�7   ├─┢� convert.awk    # Core script for Markdown to HTML slide conversion
├─┢� project
┄1�7   ├─┢� index.html     # Main entry point for the web interface
┄1�7   ├─┢� sample_md.md   # Sample Markdown file for testing
┄1�7   ├─┢� sample_pic.jpg # Sample image used in the project
┄1�7   ├─┢� sample_text.txt# Sample text file for reference
┄1�7   ├─┢� script.js      # JavaScript file for additional functionality
┄1�7   ├─┢� style.css      # CSS file for custom styling
```
